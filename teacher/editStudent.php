...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="teacherstudlist.php" class="nav-link">STUDENT LIST</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="teacherstudattend.php" class="nav-link">STUDENT ATTENDANCE</a>
      </li>
              ...
              <form role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="rfid" class="form-control" id="exampleInputrfid" placeholder="Enter RFIDNumber">
                  </div>
                </div>
                <!-- /.card-body -->
