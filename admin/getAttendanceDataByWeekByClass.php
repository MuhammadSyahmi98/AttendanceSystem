...
?>
    ...
    <!--  -->
    <!--  -->
    <div style="<?php if ($week ==="0" || empty($totalAttendance)) {
     ?>  display: none; <?php
    } ?>">
                    ...
                    <tr>
                       ...
                       <td>
                        <form method="post">
                          ...
                          <input type="hidden" name="month" value="<?php echo $week; ?>">
...
if (isset($_POST['viewAttend'])) {
  $_SESSION['current_week'] = $_POST['week'];
