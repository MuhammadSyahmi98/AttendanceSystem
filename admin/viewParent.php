          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <strong style="font-size: 110%;"><i class="fas fa-user-tie"></i> List Of Student</strong>
                ...
                <?php 
                  ...
                  while ($row2 = mysqli_fetch_assoc($result2)) {
                    ...
                    ?><p class="text-muted" style="font-size: 120%;"><?php echo $i.". ".$row2['student_name']; ?></p> <hr><?php 
                  $i=$i+1;}
