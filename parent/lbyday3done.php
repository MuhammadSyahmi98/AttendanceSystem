          ...
          <div class="form-group">
            <form method="POST" autocomplete="off">
              <div class="form-group">
                ...
                echo $date2; ?></label>
                  <div style="width: 25%;" class="input-group date" id="reservationdate" data-target-input="nearest">
                      ...
                      <button name="searchNewDate" type="submit" class="btn btn-primary" style="margin-left:5%" >Submit</button>
                  </div>
              </div> 
            </form>   
          </div>
...
$result6 = displayStudentDateAttendance($date, $student_id); 
              ...
              <div class="card-body">
                <table class="table table-striped text-nowrap">
                  ...
                  <tbody>
                    ...
                    <?php 
                    $result5 = displayStudentDateAttendance($date, $student_id); 
                     $i = 1;
...
if (isset($_POST['searchNewDate'])) {
  ...
  echo "<script>window.location.assign('lbyday3done.php')</script>";
}
